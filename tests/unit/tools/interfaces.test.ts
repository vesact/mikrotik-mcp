...
describe('parseInterfaces', () => {
  it('parses interface detail output from real device', () => {
    const raw = [
      'Flags: D - DYNAMIC; X - DISABLED; R - RUNNING; S - SLAVE',
      ' 0    S  name="ether1" default-name="ether1" type="ether" mtu=1500',
      '         actual-mtu=1500 mac-address=F4:1E:57:6C:2E:FB link-downs=0',
      '',
      ' 1   RS  name="ether2" default-name="ether2" type="ether" mtu=1500',
      '         actual-mtu=1500 mac-address=F4:1E:57:6C:2E:FC',
      '',
    ].join('\r\n');
    ...
    expect(result[0]!.macAddress).toBe('F4:1E:57:6C:2E:FB');
